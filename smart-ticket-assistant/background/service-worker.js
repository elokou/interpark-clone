...
const DEFAULTS = { enabled: false, autoClick: false, autoRotate: false, autoSelectSeats: false, maxCycles: 20, testMode: true, debugMode: false, waitTime: 800, scanInterval: 3000, scanProfile: 'balanced', eventName: '', priorityAreas: ['VIP Seat', 'R Seat', 'S Seat'], fallbackAreas: ['F1', 'E1'], excludedAreas: [], quantity: 1, strategy: 'center', rowStart: 5, rowEnd: 15, templates: [], activeTemplateId: '', logs: [], history: [], scanStats: { count: 0, pageChanges: 0, lastAt: null, currentInterval: 3000 } };
