...
const inputIds = ['eventName', 'seatAreas', 'requireContiguous', 'priorityAreas', 'fallbackAreas', 'excludedAreas', 'quantity', 'rowStart', 'rowEnd', 'waitTime', 'scanInterval', 'autoClick', 'autoRotate', 'autoSelectSeats', 'maxCycles', 'testMode', 'debugMode'];
